-- ============================================================================
-- Supabase Schema Master（完整資料庫結構，不含種子資料）
-- ============================================================================
-- 建立日期: 2026-06-02
-- 說明: 僅含 DDL（表、索引、觸發器、視圖、函數），不含任何 INSERT 種子資料
--       適用於全新 Supabase 專案，避免 user_profiles 外鍵依賴 auth.users 的問題
--
-- 涵蓋 23 張資料表（結構同 supabase_schema_master.sql）
--
